...
from bedrock_utils import predict_one_eg_mistral, predict_one_eg_claude_instant, predict_one_eg_llama_light
from prompts import (
...
def main():
    ...
    parser.add_argument("--model_name", default="mistral", choices=["claude", "mistral","llama"], help="llm name")
