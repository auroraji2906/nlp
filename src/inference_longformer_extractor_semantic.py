...
from train_longformer_extractor_context_semantic import KWDatasetContext, KeywordExtractorClf
...
def main():
    ...
    parser = argparse.ArgumentParser("Run longformer inference (Semantic-trained keyword extractor)")
    ...
    logging.info(f"Using {best_checkpoint}")
    ...
    for split in ["validation", "test"]:
        # hide_gt=True => SBERT not loaded (see semantic dataset file)
